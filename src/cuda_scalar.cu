...
void cuda_scalar_BC(void)
{
  ...
  if (dom[rank].w == MPI_PROC_NULL) {
    switch (bc_s.sW) {
      case DIRICHLET:
        BC_s_W_D<<<blocks.Gcc.num_in, blocks.Gcc.dim_in>>>(_s, bc_s.sWD);
        break;
      case NEUMANN:
        BC_s_W_N<<<blocks.Gcc.num_in, blocks.Gcc.dim_in>>>(_s, 0.);
        break;
    }
  }
  ...
  if (dom[rank].e == MPI_PROC_NULL) {
    switch (bc_s.sE) {
      case DIRICHLET:
        BC_s_E_D<<<blocks.Gcc.num_in, blocks.Gcc.dim_in>>>(_s, bc_s.sED);
        break;
      case NEUMANN:
        BC_s_E_N<<<blocks.Gcc.num_in, blocks.Gcc.dim_in>>>(_s, 0.);
        break;
    }
  }
  ...
  if (dom[rank].s == MPI_PROC_NULL) {
    switch (bc_s.sS) {
      case DIRICHLET:
        BC_s_S_D<<<blocks.Gcc.num_jn, blocks.Gcc.dim_jn>>>(_s, bc_s.sSD);
        break;
      case NEUMANN:
        BC_s_S_N<<<blocks.Gcc.num_jn, blocks.Gcc.dim_jn>>>(_s, 0.);
        break;
    }
  }
  ...
  if (dom[rank].n == MPI_PROC_NULL) {
    switch (bc_s.sN) {
      case DIRICHLET:
        BC_s_N_D<<<blocks.Gcc.num_jn, blocks.Gcc.dim_jn>>>(_s, bc_s.sND);
        break;
      case NEUMANN:
        BC_s_N_N<<<blocks.Gcc.num_jn, blocks.Gcc.dim_jn>>>(_s, 0.);
        break;
    }
  }
  ...
  if (dom[rank].b == MPI_PROC_NULL) {
    switch (bc_s.sB) {
      case DIRICHLET:
        BC_s_B_D<<<blocks.Gcc.num_kn, blocks.Gcc.dim_kn>>>(_s, bc_s.sBD);
        break;
      case NEUMANN:
        BC_s_B_N<<<blocks.Gcc.num_kn, blocks.Gcc.dim_kn>>>(_s, 0.);
        break;
    }
  }
  ...
  if (dom[rank].t == MPI_PROC_NULL) {
    switch (bc_s.sT) {
      case DIRICHLET:
        BC_s_T_D<<<blocks.Gcc.num_kn, blocks.Gcc.dim_kn>>>(_s, bc_s.sTD);
        break;
      case NEUMANN:
        BC_s_T_N<<<blocks.Gcc.num_kn, blocks.Gcc.dim_kn>>>(_s, 0.);
        break;
    }
  }
}
